...
const SHOT_PREFAB := preload("res://Utils/shot.tscn")
...
const ENEMY_MAP := {
	Character.Type.ENEMY: preload("res://Scenes/Prefabs/enemy.tscn"),
	Character.Type.ENEMY_GUN: preload("res://Scenes/Prefabs/enemy_gun.tscn"),
	Character.Type.ENEMY_KNIFE: preload("res://Scenes/Prefabs/enemy_knife.tscn"),
	Character.Type.GIRL: preload("res://Scenes/Prefabs/girl.tscn"),
	Character.Type.BOSS: preload("res://Scenes/Prefabs/boss.tscn"),
}
